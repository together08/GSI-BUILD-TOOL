...
bash "./tools"/mkuserimg_mke2fs.sh "$systemdir" "$outdir"/$packimg ext4 "/system" $size -j "0" -T "1230768000" -C "$systemdir/../config"/system_fs_config -L "system" -o "4096" "$systemdir/../config"/system_file_contexts
