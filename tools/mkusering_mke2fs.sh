...
mke2fs="$LOCALDIR/../erfangsi/tools/$HOST/bin/mke2fs"
e2fsdroid="$LOCALDIR/../erfangsi/tools/$HOST/bin/e2fsdroid"

MAKE_EXT4FS_CMD="$mke2fs $MKE2FS_OPTS -M $MOUNT_POINT -t $EXT_VARIANT -b $BLOCKSIZE $OUTPUT_FILE $SIZE"
